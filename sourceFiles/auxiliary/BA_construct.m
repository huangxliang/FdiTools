...
%BA_CONSTRUCT build transfer function from 
% 
% y         : data vectors measured using periodic broad-band excitation
% n         : transfer function numerator order
% M_mh/_ml  : lowest & highest frequency of frequency band
